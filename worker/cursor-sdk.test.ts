...
describe("Cursor SDK harness", () => {
  ...
  it("omits placeholder working directories from the local SDK bridge payload", () => {
    expect(cursorSdkTestExports.sdkWorkingDirectory(undefined)).toBeUndefined();
    expect(cursorSdkTestExports.sdkWorkingDirectory(".")).toBeUndefined();
    expect(cursorSdkTestExports.sdkWorkingDirectory("./")).toBeUndefined();
    expect(cursorSdkTestExports.sdkWorkingDirectory(" /tmp/project ")).toBe("/tmp/project");
  });
