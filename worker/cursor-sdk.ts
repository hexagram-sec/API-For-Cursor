...
function sdkWorkingDirectory(value: string | undefined): string | undefined {
  const trimmed = value?.trim();
  if (!trimmed || isPlaceholderCwd(trimmed)) return undefined;
  return trimmed;
}

function sdkBridgeWorkingDirectory(value: string | undefined): string | undefined {
  return sdkWorkingDirectory(value);
}

function isPlaceholderCwd(value: string): boolean {
